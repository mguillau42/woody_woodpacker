...
WOODY_PATH = os.path.join(PROJECT_PATH, 'woody_woodpacker')
...
def tests_woody(tests_array, args):
    ...
    for t in tests_array:
        ...
        out , rc , err = execute("{} {}".format(WOODY_PATH, t))
        ...
        if rc == -signal.SIGSEGV:
            ...
            result = "\033[91mERROR\033[0m: Error"
            errors += 1
        else:
...
if __name__ == '__main__':
    ...
    # check configuration
    if not os.path.exists(WOODY_PATH):
        if os.path.exists(PROJECT_PATH):
            print("[!] WOODY_PATH not found but PROJECT_PATH exists")
            print("[?] attempting to compile woody")
            ...
            print("[!] PROJECT_PATH \033[91mnot found\033[0m. It needs to be the absolute_path to woody")
            sys.exit(1)
